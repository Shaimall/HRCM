...
export default function Home() {
  return (
    <div>
      <header className="md:min-h-[586px] min-h-[813px] md:bg-[url('/img/headerbg3.jpg')] bg-no-repeat bg-center bg-[url('/img/headerbg2.jpg')]  ">
        <Navbar />
        <div className="relative container md:px-0 mx-auto md:py-72 pt-40 pointer-events-none ">
      ...
      <section className=" bg-[#F8F8F8]">
        <div className="container mx-auto md:pt-80 px-3 md:px-0 relative">
          ...
          <h id="aboutus" className="text-[#383838] text-5xl font-Ur  ">
            About Us.
          </h>
      ...
      <section id="projects" className="pt-40 bg-[#F8F8F8]">
      ...
      <section id="tests" className="bg-[#F8F8F8]">
      ...
      <section id="media" className="pt-40 bg-[#F8F8F8]">
      ...
      <section id="clients" className=" pt-20 pb-40 bg-[#F8F8F8]">
