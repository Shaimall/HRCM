  ...
  return (
    <div className="grid md:grid-cols-3 text-center md:text-left py-12 ">
      <div className="flex flex-col gap-8 ">
        <h className="text-3xl font-Urb text-[#C0A05E] md:text-white">
          Exclusive<br></br> Builder
        </h>
        <p className="md:border-t-[17px] border-t-2 font-Urm border-[#EBEBEB] text-[#383838] text-base pt-2 md:pt-8 md:w-3/4 md:h-3/4 mx-auto md:mx-0 ">
      ...
      <div className="flex flex-col gap-8 md:mt-0 mt-10  ">
        ...
        <p className="md:border-t-[17px] border-t-2 font-Urm border-[#EBEBEB] text-[#383838] text-base pt-2 md:pt-8 md:w-3/4 mx-auto md:mx-0 ">
      ...
      <div className="flex flex-col gap-8 mt-10 md:mt-0  ">
        ...
        <p className="md:border-t-[17px] border-t-2 font-Urm border-[#EBEBEB] text-[#383838] text-base pt-2 md:w-3/4 md:pt-8 mx-auto md:mx-0  ">
