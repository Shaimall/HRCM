  ...
  return (
    <div className="grid md:grid-cols-3 text-center md:text-left py-12 ">
      <div className="flex flex-col gap-8">
        ...
        <p className="md:border-t-[17px] border-t-2 border-[#EBEBEB] text-[#383838] text-base pt-2 md:pt-8 md:w-3/4 mx-auto md:mx-0">
      ...
      <div className="flex flex-col gap-8 mt-10 md:mt-0">
        ...
        <p className="md:border-t-[17px] border-t-2 border-[#EBEBEB] text-[#383838] text-base pt-2 md:w-3/4 md:pt-8 mx-auto md:mx-0">
